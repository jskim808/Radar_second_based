    ...
    def predict(self, example, preds_dict):
        ...
        for box_preds, cls_preds, dir_preds, a_mask, meta in zip(
            ...
            if selected_boxes.shape[0] != 0:
                ...
                box_preds_offsetx = copy.deepcopy(selected_boxes)
                ...
                if self._use_direction_classifier:
                    ...
                    dir_offset_rot = box_torch_ops.limit_period(
                        box_preds_offsetx[..., 6],
                        self._dir_limit_offset, period)
                    box_preds[
                        ...,
                    ...
                    box_preds_offsetx[
                        ...,
                        6] = dir_offset_rot + period * dir_labels.to(
                            box_preds_offsetx.dtype)
                final_box_preds_offsetx = box_preds_offsetx
                ...
                if post_center_range is not None:
                    ...
                    predictions_dict = {
                        ...
                        "box3d_offsetx" : final_box_preds_offsetx[mask],                        
                    ...
                    predictions_dict = {
                        ...
                        "box3d_offsetx" : final_box_preds_offsetx,
                        "scores": final_scores,
